...
func (r *stackRepository) CreateStack(ctx context.Context, s Stack) (Stack, error) {
...
func (r *stackRepository) SelectStackByName(ctx context.Context, applicationName string, stackName string) (Stack, error) {
	...
	if err != nil {
		...
		return Stack{}, ErrSearchStackByName
	}
	return toStackDomain(entity), nil
}

func (r *stackRepository) SearchAllStacksByApplicationName(ctx context.Context, applicationName string) ([]Stack, error) {
	return nil, nil
}
